...
|-------------------------------------------------------------------------------------------------------------------------------------------|----------------------|--------------------|----------------|-----------------|---------------------|-----------------|-------------------------|----------------------|----------------------|
| [**Admen**](./src/hrflow_connectors/connectors/admen/README.md) | ATS | :white_check_mark: | *14/06/2024* | *22/07/2024* | :white_check_mark: | :white_check_mark: | :white_check_mark: | :x: | :x: |
| **ADP**                                                                                                                                   | HCM            | 🎯                 |                |                 |                     |                 |                         |                      |
| **Applicantstack**                                                                                                                              | ATS                  | 🎯                 |                |                 |                     |                 |                         |                      |
| **Ashby**                                                                                                                              | ATS                  | 🎯                 |                |                 |                     |                 |                         |                      |
| **BambooHR**                                                                                                                              | ATS                  | 🎯                 |                |                 |                     |                 |                         |                      |
