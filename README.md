...
| **BizMerlinHR**                                                                                                                              | ATS                  | 🎯                 |                |                 |                     |                 |                         |                      |
| **Beetween**                                                                                                                              | ATS                  | 🎯                 |                |                 |                     |                 |                         |                      |
| [**Bullhorn**](./src/hrflow_connectors/connectors/bullhorn/README.md) | ATS | :white_check_mark: | *26/01/2022* | *02/08/2024* | :white_check_mark: | :white_check_mark: | :white_check_mark: | :x: | :x: |
