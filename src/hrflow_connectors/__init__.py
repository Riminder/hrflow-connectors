...
__version__ = "2.0.0"
__CONNECTORS__ = [SmartRecruiters, TalentSoft, PoleEmploi, Adzuna, Recruitee, Workable, BreezyHR, SAPSuccessFactors, Bullhorn, Ceridian, Greenhouse, Teamtailor, Waalaxy]
