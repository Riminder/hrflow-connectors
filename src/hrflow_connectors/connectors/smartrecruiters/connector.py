...
SmartRecruiters = Connector(
    ...
    actions=[
        ConnectorAction(
            ...
            screenshot_urls=[
                "https://www.smartrecruiters.com/wp-content/themes/smartrecruiters/"
                "new-template/img/en_us/home/ash-screen-select.jpg"
            ],
        ),
        ConnectorAction(
            name="push_profile",
            ...
            screenshot_urls=[
                "https://www.smartrecruiters.com/wp-content/themes/smartrecruiters/"
                "new-template/img/en_us/home/ash-screen-attract.jpg"
            ],
        ),
    ],
)
