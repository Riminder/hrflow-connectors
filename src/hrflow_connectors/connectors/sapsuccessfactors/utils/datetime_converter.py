...
def from_str_to_datetime(datetime_str: str) -> datetime.datetime:
    ...
    """
    isoformat_regex = r"""^(?P<year>\d{4})(-|/)(?P<month>\d{2})(-|/)(?P<day>\d{2})(.
    (?P<hour>\d{2})(:(?P<minute>\d{2})(:(?P<second>\d{2})(\.(?P<millisecond>\d{1,6}))
    ?)?)?)?(?P<tz>((?P<tz_symbol>-|\+)(?P<tz_hour>\d{2}):?(?P<tz_minute>\d{2})(:(?P<t
    z_second>\d{2})(\.(?P<tz_millisecond>\d{1,6}))?)?)|Z)?$"""
