...
`UKGPro Jobs` :arrow_right: `HrFlow.ai Jobs`

Retrieve jobs from UKGPro and index them to a HrFlow board.
...
| `format`    | `typing.Callable[[typing.Dict], typing.Dict]`                               | [`format_ukgpro_job`](../connector.py#L49) | Formatting function                                                                                                                                                                                                                             |
