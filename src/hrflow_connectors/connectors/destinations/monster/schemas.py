...
class MonsterProfile(BaseModel):
    ...
    FileContents: List[int] = Field(..., Description="Content of the resume of the profile on the form of a list of int")
    FileExt: str = Field(..., Description="This contains the resume in its original format as it was made available "
    ...
    ResumeValue: str = Field(..., Description="This is a unique alpha numeric value on the Monster side.")
    State: str
    VendorField: str = Field(..., Description="Commentary from the job")
    WorkAuthorization: int = Field(..., Description="This is a value of whether the applicant is authorized to work "
