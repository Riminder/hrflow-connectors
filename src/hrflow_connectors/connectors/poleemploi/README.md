...
| Action | Description |
| ------- |  -------- |
| [**Pull job list**](docs/pull_job_list.md) | Retrieves jobs via the [***Offres d'emploi v2*** API](https://pole-emploi.io/data/api/offres-emploi?tabgroup-api=presentation&doc-section=api-doc-section-caracteristiques) from the Pôle emploi website based on selection criteria and send them to a ***Hrflow.ai Board***.|
