...
class FlatchrResume(BaseModel):
    ...
    contentType: Optional[str] = Field("application/octet-stream", Description="Type of the content of the file")
...
class FlatchrEducationDegree(BaseModel):
    name: Optional[str] = Field(None, Description="Degree of the education")
    date: Optional[str] = Field(None, Description="Date on which the degree was obtained")
...
class FlatchrEducationProfile(BaseModel):
    ...
    descriptions: List[Optional[str]] = Field([None], Description="Description of the education")


class FlatchrGeoLocation(BaseModel):
    latitude: Optional[float] = Field(None, Description="Latitude of the employment location")
    longitude: Optional[float] = Field(None, Description="Longitude of the employment location")


class FlatchrAddres1(BaseModel):
    countryCode: Optional[str] = Field(None, Description="Country code of the employment location")
    city: Optional[str] = Field(None, Description="City of the employment location")
    postalCode: Optional[str] = Field(None, Description="Postalcode of the employment location")
    geoLocation: FlatchrGeoLocation = Field(
        None, Description="GeoLocation object of the employment location"
    )
    formattedAddress: Optional[str] = Field(None, Description="Address of the employment location")
...
class FlatchrPositionHistory(BaseModel):
    ...
    start: Optional[str] = Field(None, Description="Date of the start of the employment")
    current: Optional[bool] = Field(None, Description="Is this employment the current employment")
...
class FlatchrEmploymentProfile(BaseModel):
    ...
    descriptions: List[Optional[str]] = Field([None], Description="Description of the experience")
...
class FlatchrPhoneProfile(BaseModel):
    dialNumber: Optional[str] = Field("XXXXX", Description="Number of the phone of the candidat")
...
class FlatchrValueProfile(BaseModel):
    ...
    phone: Optional[List[FlatchrPhoneProfile]] = Field("XXXXX", Description="Phone of the candidat")
    email: Optional[List[FlatchrEmailProfile]] = Field(
        None, Description="Email adress of the candidat"
    )
    position: Optional[List[Optional[str]]] = Field(None, Description="Position of the candidat")
    employment_positions: Optional[List[Optional[str]]] = Field(
        None, Description="Employment adress of the candidat"
    )
    experience: Optional[int] = Field(None, Description="Years of experience of the candidat")


class FlatchrEnrichmentProfile(BaseModel):
    app_name: Optional[str] = Field("HRMatch", Description="App name, 'HRMatch' by default")
    ...
    type: Optional[str] = Field("applicants", Description="'applicants by default'")
    value: Optional[FlatchrValueProfile] = Field(None, Description="Content of the profile")
