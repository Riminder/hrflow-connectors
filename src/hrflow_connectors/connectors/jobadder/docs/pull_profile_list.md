...
| `candidateId`  | `typing.List[int]` | None | Candidate Id |
...
| `statusId`  | `typing.List[int]` | None | Candidate status |
| `recruiterUserId`  | `typing.List[int]` | None | User Id - search candidates by associated recruiters |
| `folderId`  | `typing.List[int]` | None | Search in specific folders |
| `createdAt`  | `typing.List[str]` | None | Search for candidates created at a specific date and time (UTC assumed, ISO date-time) |
| `updatedAt`  | `typing.List[str]` | None | Search for candidates updated at a specific date and time (UTC assumed, ISO date-time) |
| `sort`  | `typing.List[str]` | None | Sort the results by one or multiple fields, prefix with '-' to sort descending |
| `fields`  | `typing.List[str]` | None | Additional fields to include with the results |
| `embed`  | `typing.List[str]` | None | Embed related resources |
