...
| `candidateId`  | `typing.List[int]` | [] | Candidate Id |
...
| `statusId`  | `typing.List[int]` | [] | Candidate status |
| `recruiterUserId`  | `typing.List[int]` | [] | User Id - search candidates by associated recruiters |
| `folderId`  | `typing.List[int]` | [] | Search in specific folders |
| `createdAt`  | `typing.List[str]` | [] | Search for candidates created at a specific date and time (UTC assumed, ISO date-time) |
| `updatedAt`  | `typing.List[str]` | [] | Search for candidates updated at a specific date and time (UTC assumed, ISO date-time) |
| `sort`  | `typing.List[str]` | [] | Sort the results by one or multiple fields, prefix with '-' to sort descending |
| `fields`  | `typing.List[str]` | [] | Additional fields to include with the results |
| `embed`  | `typing.List[str]` | [] | Embed related resources |
