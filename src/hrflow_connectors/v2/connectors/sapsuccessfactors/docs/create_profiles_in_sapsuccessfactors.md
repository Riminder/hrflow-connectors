# Create profiles in sapsuccessfactors
`HrFlow` :arrow_right: `SAP SuccessFactors`

Send **created** 'profile(s)' _from_ HrFlow _to_ SAP SuccessFactors
...
## Push Parameters (SAP SuccessFactors)
...
SAPSuccessFactors.create_profiles_in_sapsuccessfactors(
    workflow_id=...,
    logics=...,
    connector_auth=dict(
        api_server=...,
