# Update profiles in sapsuccessfactors
`HrFlow` :arrow_right: `SAP SuccessFactors`

Send **updated** 'profile(s)' _from_ HrFlow _to_ SAP SuccessFactors
...
SAPSuccessFactors.update_profiles_in_sapsuccessfactors(
    workflow_id=...,
    logics=...,
    connector_auth=dict(
        api_server=...,
