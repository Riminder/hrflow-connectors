...
class SAPSuccessFactorsProto(Connector):
    ...
    create_profiles_in_sapsuccessfactors: PublicActionInterface
    update_profiles_in_sapsuccessfactors: PublicActionInterface
    
SAPSuccessFactors: SAPSuccessFactorsProto