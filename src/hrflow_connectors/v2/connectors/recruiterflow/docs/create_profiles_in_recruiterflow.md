# Create profiles in recruiterflow
`HrFlow` :arrow_right: `Recruiterflow`

Send **created** 'profile(s)' _from_ HrFlow _to_ Recruiterflow
...
Recruiterflow.create_profiles_in_recruiterflow(
    workflow_id=...,
    logics=...,
    connector_auth=dict(
        rf_api_key=...,
