...
## Prerequisites
Before you can develop new connectors or update existing ones you need to have `python` _3.6.7_ or above and [poetry](https://python-poetry.org/docs/) installed.
