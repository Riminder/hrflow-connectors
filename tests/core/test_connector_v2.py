...
SmartLeadsInboundF = lambda: Connector(
    name="SmartLeads",
    ...
    actions=[
        ...
        ConnectorAction(
            ...
            target=HrFlowReadProfileWarehouse,
            action_type=ActionType.inbound,
            action_mode=ActionMode.create,
        ),
    ],
...
def test_connector_failures():
    ...
    result = SmartLeads.create_profiles_in_hrflow(
        ...
        pull_parameters=dict(),
        push_parameters=dict(source_key=source_key),
    )
    assert result.status == Status.fatal
...
#         connector_auth_parameters=dict(),
#         hrflow_auth_parameters=dict(
#             api_user="api_secret_xxx1", api_secret="api_user_xxx1@hrflow.ai"
#         ),
#         pull_parameters=dict(),
