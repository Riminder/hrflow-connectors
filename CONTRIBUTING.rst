...
You can help improve ``hrflow-connectors`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``hrflow-connectors`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``hrflow-connectors``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n hrflow-connectors python=3 six virtualenv pytest pytest-cov
    conda activate hrflow-connectors
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/hrflow-connectors.git
    cd hrflow-connectors
...
#. Install |pre-commit|_::
   ...
   ``hrflow-connectors`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/hrflow-connectors
.. _issue tracker: https://github.com/<USERNAME>/hrflow-connectors/issues
.. <-- end -->
